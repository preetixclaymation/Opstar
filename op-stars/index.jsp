<%
	if(session.getAttribute("email") == null) {
        System.out.println("FIRST INITIALLY COME HERE");
...
<head>
    ...
    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
     <script src="https://statics.teams.cdn.office.net/sdk/1.6.00.1381/js/MicrosoftTeams.min.js"></script>
                                ...
                                <div class="Tabs-tablist Tabs-tablist--dark">
                                    ...
                                    <div onclick="changeCategory(this)" id="tabs-1621963902276-tab-2" tabindex="-1"
                                        ...
                                        <span class="Eyebrow "><span>Listen</span></span>
                                          ...
                                          <div onclick="sortCard()" id="sortTab" tabindex="-1"
                                                             role="tab" aria-selected="false" aria-controls="tabs-1621963902276-tab-3-panel"
                                                              class="Tabs-tab Tabs-tab--dark">
                                                               <span class="Eyebrow "><span>Show Latest Video</span></span>
                                          </div>
